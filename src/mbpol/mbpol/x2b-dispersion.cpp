...
const double x2b_dispersion::d6_HH = 9.497544671968207e+00; // A^(-1)
const double x2b_dispersion::d6_OH = 8.438042632623597e+00; // A^(-1)
const double x2b_dispersion::d6_OO = 7.816819148473769e+00; // A^(-1)
