!NOTE: This version has been modifiedd to suit he needs of the Linpolexe
!program. Not much has changed, however. The changes include:
!       - wrapper module
!       - optional lodical doGradient if present and false costy gradient
!         calculation are omitted
module mod_ttm3f
contains
subroutine ttm3f(Nw,RR,dRR,En,doGradient)
...
!ADDED by MFH32:
logical, optional, intent(in) :: doGradient
!
