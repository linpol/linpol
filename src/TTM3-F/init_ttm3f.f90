!***
!*** mfh32, 27/01/2013:    I obtained these routines from
!***              http://www.pnl.gov/science/docs/nttm3f.tgz
!*** and moved duplicated things(with linpol, WHBB) into common library dir (shared)
!***
